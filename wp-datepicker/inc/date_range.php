...
<tr>
<td class="wpdp-dd"><input type="number" name="wpdp_range[<?php echo $selector_date_range; ?>][day]" max="31" min="0" value="<?php echo esc_attr($wpdp_range_d); ?>" /></td>
<td></td>
<td class="wpdp-mm"><input type="number" name="wpdp_range[<?php echo $selector_date_range; ?>][month]" max="12" min="0" value="<?php echo esc_attr($wpdp_range_m); ?>" /></td>
<td></td>
<td class="wpdp-yy"><input type="number" name="wpdp_range[<?php echo $selector_date_range; ?>][year]" min="0" value="<?php echo esc_attr($wpdp_range_y); ?>" /></td>
</tr>
</table>
</div>
